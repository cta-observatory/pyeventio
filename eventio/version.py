...
try:
    ...
    warnings.warn(
        "Could not determine eventio version; this indicates a broken installation."
        " Install eventio from PyPI, a local git repository or using "
        " pip install git+https://github.com/cta-observatory/pyeventio@VERSION "
