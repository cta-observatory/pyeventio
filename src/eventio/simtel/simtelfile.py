...
class SimTelFile:
    ...
    def _read_next_event(self):
        ...
        # observation level particles in Photon block
        if isinstance(self._file.peek(), iact.Photons):
            self._parse_next_object()
    ...
    def _build_event(self):
        ...
        if self.current_obslev_particles is not None and event["type"] == "data":
            event["observation_level_particles"] = self.current_obslev_particles
